...
class ProductUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_form_class(self):
        ...
        if user == self.object.owner:
            return ProductForm
        if user.has_perm('catalog.can_cancel_published') and user.has_perm('catalog.can_change_product_description') and user.has_perm('catalog.can_change_product_category'):
